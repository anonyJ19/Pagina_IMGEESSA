...
<head>
    ...
    <link rel="icon" id="favicon" type="image/png" href="{{ asset('img/favicon.png') }}?v=4">
...
<body class="bg-slate-50 text-brand-navy dark:bg-brand-navy-dark dark:text-zinc-100 min-h-screen flex flex-col transition-colors duration-300 antialiased"
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="space-y-1 px-4 py-3">
                ...
                <a href="{{ route('contacto') }}" 
                   id="mobile-nav-cta"
                   class="mt-4 block w-full rounded-xl bg-brand-cyan hover:bg-brand-cyan-dark px-4 py-2.5 text-center text-base font-bold text-brand-navy shadow-md transition-all duration-300 dark:text-white"
                   @click="mobileMenuOpen = false">
                    Cotizar Proyecto
                </a>
            </div>
    ...
    <!-- Footer Section -->
    <footer class="border-t border-zinc-200 bg-slate-100 text-brand-slate dark:border-brand-navy/55 dark:bg-brand-navy dark:text-zinc-300 transition-colors duration-300">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="mt-2.5 space-y-1.5 text-[13px]">
                        ...
                        <!-- Facebook -->
                        <li>
                            <a href="https://www.facebook.com/people/Imgeessa-Soluciones-Integrales-HSEQ/100075735164676/?locale=es_LA" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-zinc-500 hover:text-brand-cyan dark:text-zinc-300 dark:hover:text-brand-cyan transition-colors duration-200">
                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <!-- Instagram -->
                        <li>
                            <a href="https://www.instagram.com/imgeessa/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-zinc-500 hover:text-brand-cyan dark:text-zinc-300 dark:hover:text-brand-cyan transition-colors duration-200">
                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <!-- X (Twitter) -->
                        <li>
                            <a href="https://x.com/ImgeessaHseq" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-zinc-500 hover:text-brand-cyan dark:text-zinc-300 dark:hover:text-brand-cyan transition-colors duration-200">
                        ...
                        <!-- LinkedIn -->
                        <li>
                            <a href="https://www.linkedin.com/in/imgeessa-sas-7881ba306/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-zinc-500 hover:text-brand-cyan dark:text-zinc-300 dark:hover:text-brand-cyan transition-colors duration-200">
                                <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div class="p-3 bg-white dark:bg-brand-navy-dark pt-1 flex-shrink-0">
                <div class="flex items-center gap-2 relative">
                    ...
                    <button @click="sendMessage" 
                            ...
                            class="absolute right-1 p-2 rounded-full bg-brand-cyan text-brand-navy hover:bg-brand-cyan-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed dark:text-white">
    ...
    <div x-data="{ showCookies: !localStorage.getItem('cookiesAccepted') }" 
         x-show="showCookies" 
         ...
         class="fixed bottom-0 left-0 z-[60] w-full bg-white/95 backdrop-blur-sm border-t border-zinc-200/60 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] dark:bg-brand-navy-dark/95 dark:border-brand-navy/60 transition-colors duration-300"
         style="display: none;">
        <div class="max-w-7xl mx-auto px-4 py-5 md:px-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
            <div class="flex-1">
                <h4 class="font-black text-red-600 dark:text-red-400 text-sm tracking-wider uppercase mb-1.5 flex items-center gap-2">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                    Cookies
                </h4>
                <p class="text-sm text-brand-slate dark:text-zinc-300 leading-relaxed">
                    Este sitio web usa cookies propias y de terceros para analizar el tráfico, mejorar nuestros servicios y conocer el comportamiento del usuario. Para conocer más, acceda a nuestra <a href="#" class="font-bold underline hover:text-brand-cyan transition-colors dark:text-white dark:hover:text-brand-cyan">Política de Cookies</a>.
                </p>
            </div>
            <button @click="localStorage.setItem('cookiesAccepted', 'true'); showCookies = false" 
                    class="shrink-0 px-6 py-2.5 border-2 border-brand-navy text-brand-navy font-extrabold text-sm uppercase tracking-wider hover:bg-brand-navy hover:text-white transition-all duration-300 dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-brand-navy-dark rounded-md w-full md:w-auto shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-cyan focus:ring-offset-2 dark:focus:ring-offset-brand-navy-dark">
                Entendido
            </button>
        </div>
    </div>
